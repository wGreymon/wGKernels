...
- `tests/test_reduce/scripts/test_reduce.py`
...
WGKERNEL_NCU_EXPORT="tests/test_reduce/profiling/reduce_sum_basic" \
...
- `tests/test_reduce/profiling/reduce_sum_basic.ncu-rep`
- `tests/test_reduce/profiling/reduce_max_basic.ncu-rep`
- `tests/test_reduce/profiling/reduce_argmax_basic.ncu-rep`
...
```bash
ncu --import tests/test_reduce/profiling/reduce_sum_basic.ncu-rep --page details
```
